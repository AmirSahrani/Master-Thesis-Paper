...
\begin{figure}
	\begin{tikzpicture}[>=latex,line join=bevel,scale=0.8]
		%%
		\node (123) at (27.0bp,36.0bp) [draw,rectangle] {$a \pref b \pref c$};
		\node (132) at (117.0bp,64.0bp) [draw,rectangle] {$a \pref c \pref b$};
		\node (213) at (477.0bp,36.0bp) [draw,rectangle] {$b \pref a \pref c$};
		\node (312) at (207.0bp,64.0bp) [draw,rectangle] {$c \pref a \pref b$};
		\node (231) at (387.0bp,64.0bp) [draw,rectangle] {$b \pref c \pref a$};
		\node (321) at (297.0bp,64.0bp) [draw,rectangle] {$c \pref b \pref a$};
