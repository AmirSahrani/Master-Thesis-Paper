...
% Which statistics ~ might have some stats to find lowest combination, everything else from senstivity
% Elaborate a bit on senstivity analysis, also explain what it means before hand
% clean up structure between "experiments" and "DeGroot extension"
% Proof read
% Expand a bit on the replication, explain what it shows
%
%
%
...
independent variables laid out in \Cref{tab: indepdent_variables}, we exclude \texttt{Candidates}, and \texttt{Candidate Generator} in this section.

we are able to generate potential
