...
establish baseline measurements. Second, we develop and validate the adapted 
DeGroot model using data from the America in One Room experiment.
...
between 0.45 and 0.99 in steps of 0.1, for each bias factor we run 100
...
\begin{table}
	...
	\caption{The parameters of the adapted DeGroot model and their values. Parameters marked with asterisk are randomized during sensitivity analysis.}
\end{table}
