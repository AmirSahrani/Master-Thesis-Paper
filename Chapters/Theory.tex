...
\Cref{section:related_work}, aim to model deliberation and show that
...
\begin{definition}{Biased Deliberation}{biased_delib} A deliberative procedure
	...
	this assumption is a weak and natural in the light of the current
	...
	\Cref{AppendixA} \begin{proofc} Assume the following population: we
...
satisfying our requirements. \end{proofc}
...
More specifically, our model is adapted from the DeGroot learning model, which
...
Using this model of deliberation, meta-agreement can be seen as some estimated
...
\section{Agent Based Deliberation} \textcolor{RedViolet}{I have not thought
...
\begin{equation} \label{eq:abm_update_function} \sqrt{k_{i}\iota_{i,j}
