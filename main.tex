...
\acknowledgements{\addtocontents{toc}{\vspace{1em}} % Add a gap in the Contents, for aesthetics
	...
	I would like to thank Ulle Endriss for helping me walk the tightrope
	between scientific disciplines, I found myself walking during this
	thesis. His guidance has been of tremendous help whenever I found
	myself lost, confused or when I was simply getting ahead of myself.
...
\listofnomenclature{ll} % Include a list of Symbols (a three column table)
{
	...
	$\alternatives$ & The set of all alternatives\\
