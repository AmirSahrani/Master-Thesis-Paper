...
\abstract{\addtocontents{toc}{\vspace{1em}} % Add a gap in the Contents, for aesthetics
	...
	We begin by reviewing theoretical foundations from social choice, focusing on
	domain restrictions like single-peakedness, and by discussing deliberative
	democracy and the concept of meta-agreement. We then replicate the
	model by \citet{radDeliberationSinglePeakednessCoherent2021}, which models deliberation as preference updating
	under various distance metrics. While their model can increase
	proximity to single-peakedness, it does not capture meta-agreement and is
	...
	weight others’ opinions. Using data from the \textsc{America in One
		Room} experiment \cite{fishkinCanDeliberationHave2024}, we calibrate
	...
	informed does not always translate to persuasive influence.
	...
	analysis identifies drivers of opinion convergence and highlights the
	interaction effects between trust, bias, and group composition. These
	results suggest that while deliberation may indeed structure
