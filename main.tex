...
\listofnomenclature{ll} % Include a list of Symbols (a three column table)
{
	...
	$\biasedDeliberation$ &  A deliberative Procedure\\
	...
	$\strictProfile$ & Set of preferences for all voters\\
	...
	$\EstSupport$ & $|\alternatives| \times |\policies|$ matrix estimating support of policies for each alternative\\
